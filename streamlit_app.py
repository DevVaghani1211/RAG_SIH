...
st.set_page_config(
    page_title="Aspire | Student Portfolio AI",
    page_icon="✨",
    layout="centered",
    initial_sidebar_state="auto"
)

st.title("🎓 Aspire | Student Portfolio AI")
...
if "messages" not in st.session_state:
    st.session_state.messages = [{"role": "assistant", "content": "Hello! I am Aspire. How can I assist you with the student records today?"}]
...
if prompt := st.chat_input("Ask Aspire a question..."):
